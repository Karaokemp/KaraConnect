...
public FFmpegBuilder setVideoSize(String videoSize) {
	this.videoSize = checkNotNull(videoSize);
	return this;
}

public FFmpegBuilder setFramerate(String framerate) {
	this.framerate = checkNotNull(framerate);
	return this;
}

public FFmpegBuilder setVcodec(String vcodec) {
	this.vcodec = checkNotNull(vcodec);
	return this;
}
}

...
public class UploadVideo {
	...
	public static String uploadVideo(File file, String[] meta, String eventName) throws Exception {
		...
		youtube = new YouTube.Builder(Auth.HTTP_TRANSPORT, Auth.JSON_FACTORY, credential)
				.setApplicationName("karaokemp-youtube-uploader").build();
		...
		snippet.setTitle((meta[MainUpload.PERFORMER] + " Performing " + meta[MainUpload.SONG] + " In " + eventName + " " + meta[MainUpload.TIME]));
		snippet.setDescription("Performed on Karaokemp's stage");
		
		System.out.println("Uploading: " + snippet.getTitle());
		...
		MediaHttpUploaderProgressListener progressListener = new MediaHttpUploaderProgressListener() {
			public void progressChanged(MediaHttpUploader uploader) throws IOException {
				...
				case MEDIA_IN_PROGRESS:
					...
					System.out.println("Process percentage: " + new BigDecimal((double)uploader.getNumBytesUploaded() / fileSize * 100).intValue() + "%");
					break;
				case MEDIA_COMPLETE:

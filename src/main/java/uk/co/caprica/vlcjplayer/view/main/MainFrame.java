...
public final class MainFrame extends BaseFrame {
    ...
    private final Action viewPlaylistAction;
    ...
    public PositionPane positionPane;
    ...
    public JPanel bottomControlsPane = new JPanel();
    ...
    public MainFrame() {
        ...
        viewPlaylistAction = new StandardAction(resource("menu.view.item.playlist")) {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				application().post(ShowPlaylistEvent.INSTANCE);				
			}
		};
        ...
        viewMenu.add(new JMenuItem(viewPlaylistAction));
            ...
            public void mediaDurationChanged(MediaPlayer mediaPlayer, long newDuration) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PlaylistFrame.setDuration(newDuration);
                    }
                });
            }
